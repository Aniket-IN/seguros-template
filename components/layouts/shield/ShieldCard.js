...
const ShieldCard = () => {
  const data = [
    {
      key: "Administradores",
      value: <>Juan Jesús Ledesma<br />Lucia Candiotti</>,
    },
    {
      key: "N° de Miembros",
      value: "08",
  ...
  return (
    <div className="bg-white px-5 py-10 gap-7 sm:flex items-center 2xl:block">
      ...
      <div className="text-center">
        <img className="mx-auto w-24 aspect-square rounded-full" src="/assets/img/sample/companies/fanta.png" alt="Fanta" />
        <h4 className="mt-3 font-semibold text-lg">Familia</h4>
