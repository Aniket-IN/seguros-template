...
const UserCard = ({currentTicketId , currentTicketuser}) => {
  ...
  useEffect(() => {
     console.log("from user card ", currentTicketId)
  ...
  return (
    <div className="bg-white p-5">
      <div className="text-center">
        ...
        {!currentTicketId.active?<dd className="text-[15px] font-semibold text-success">
          Ticket Resuelto
        </dd>:<dd className="text-[15px] font-semibold text-danger">
          Ticket Pendiente
        </dd>}
      </div>
